...
public class ApolloSMP extends JavaPlugin {
    ...
    private void registerCommands() {
        ...
        reg("rtp", rtpCommand);
        reg("spawn", rtpCommand);
        reg("setspawn", rtpCommand);
    ...
    private void saveSpawn() {
        ...
        cfg.set("world", spawn.getWorld().getName());
        cfg.set("x", spawn.getX());
        cfg.set("y", spawn.getY());
        cfg.set("z", spawn.getZ());
        cfg.set("yaw", spawn.getYaw());
        cfg.set("pitch", spawn.getPitch());
        try {
            cfg.save(new File(getDataFolder(), "spawn.yml"));
        } catch (IOException e) {
